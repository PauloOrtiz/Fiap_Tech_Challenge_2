...
with tab1:
    ...
    with st.expander("Ver a fórmula do ARIMA"):
        ...
        st.markdown("""
            ...
            3. **$phi_1$**: Relacionam a observação atual com suas anteriores. O número de termos é determinado por $p$.
            4. **$theta_1$**: Relacionam o erro da observação atual com erros passados. O número de termos é determinado por $q$.
