...
with tab5:
    ...
    - **gráfico 1** -> Residuos padronizados 1 passo a frente, não apresentam estrutura óbvia.
    - **gráfico 2** -> Distribuição normal de resíduos - A distribuição de resíduos está bem ajustada a distribuição normal dos dados.
